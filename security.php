...
$page[ 'title' ]   = 'Lab Security' . $page[ 'title_separator' ].$page[ 'title' ];
...
<div class=\"body_padded\">
	<h1>Lab Security <img src=\"" . DVWA_WEB_PAGE_TO_ROOT . "dvwa/images/lock.png\" /></h1>
	<br />
	...
	<p>PHPIDS works by filtering any user supplied input against a blacklist of potentially malicious code. It is used to serve as a live example of how Web Application Firewalls (WAFs) can help improve security and in some cases how WAFs can be circumvented.</p>
