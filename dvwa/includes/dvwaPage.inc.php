...
function dvwaHtmlEcho( $pPage ) {
	...
	if( dvwaIsLoggedIn() ) {
		...
		$menuBlocks[ 'vulnerabilities' ][] = array( 'id' => 'dt', 'name' => 'Directory/Path Traversal', 'url' => 'vulnerabilities/dt/.?page=include.php' );
	...
	$systemInfoHtml = "";
	if( dvwaIsLoggedIn() )
		$systemInfoHtml = "<div align=\"left\">{$userInfoHtml}<br />{$securityLevelHtml}";
	...
	<body class=\"home\">
		<div id=\"container\">
			...
			<div id=\"footer\">
				...
				<p>CyberSecurity Academy by Digitalna Dalmacija</p>
